...
/** A serializable bounded range split scoped by chain-native key predicates. */
public record Web3KeyedRangeSplit(Map<String, String> keys, String rangeColumn, long startInclusive, long endInclusive)
        implements ConnectorSplit
{
    ...
    @JsonCreator
    public Web3KeyedRangeSplit(
            @JsonProperty("keys") Map<String, String> keys,
            @JsonProperty("rangeColumn") String rangeColumn,
