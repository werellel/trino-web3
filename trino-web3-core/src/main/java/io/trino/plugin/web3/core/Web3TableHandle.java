...
public record Web3TableHandle(String schemaName, String tableName, Optional<BlockRange> blockRange)
        implements ConnectorTableHandle
{
    ...
    {
        return new Web3TableHandle(schemaName, tableName, Optional.of(requireNonNull(blockRange, "blockRange is null")));
    }
}
