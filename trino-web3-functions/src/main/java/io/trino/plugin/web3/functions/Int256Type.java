...
public final class Int256Type
        extends Web3Int256Type
{
    public static final Int256Type INT256 = new Int256Type();

    private Int256Type()
    {
        super("int256", true, Operators.class);
    }
    ...
    private static final class Operators
    {
        ...
        {
            return Web3IntegerCodec.decodeSigned(left).compareTo(Web3IntegerCodec.decodeSigned(right));
        }
